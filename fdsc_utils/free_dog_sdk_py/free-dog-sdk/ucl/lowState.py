...
class lowState:
    ...
    def parseData(self, data):
        ...
        self.footForce = [int.from_bytes(data[739:741], byteorder='little'), int.from_bytes(data[741:743], byteorder='little'), int.from_bytes(data[743:745], byteorder='little'), int.from_bytes(data[745:747], byteorder='little')]
        self.footForceEst = [int.from_bytes(data[747:749], byteorder='little'), int.from_bytes(data[749:751], byteorder='little'), int.from_bytes(data[751:753], byteorder='little'), int.from_bytes(data[753:755], byteorder='little')]
